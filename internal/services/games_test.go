...
func TestGamesServiceDetectGameReShadeReturnsUnsupportedWithoutStorageAccess(t *testing.T) {
	t.Parallel()

	service := NewGamesService(nil, testLogger())
...
func TestGamesServiceDetectGameReShadeValidatesInstallPath(t *testing.T) {
	t.Parallel()
	...
	service := NewGamesService(store, testLogger())
...
func TestGamesServiceDetectGameReShadeReturnsDetectedTargets(t *testing.T) {
	t.Parallel()
