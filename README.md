...
**Prerequisites:** Go 1.26.4+, Wails v3 CLI `v3.0.0-alpha2.111`, Bun 1.3.x. On Linux, install GTK4/WebKitGTK 6.0 development packages (`libgtk-4-dev`, `libwebkitgtk-6.0-dev`, and related build tools).
